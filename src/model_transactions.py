...
# Наши поля
NUMERICAL   = ["Amount", "Hour of Day", "Session Duration", "Login Frequency", "Risk Score"]
CATEGORICAL = ["Transaction Type", "Location Region", "IP Prefix", "Purchase Pattern", "Age Group"]
